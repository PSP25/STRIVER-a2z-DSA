...
void DEQUE(){
  deque<int> dq;
   cout<<dq.empty()<<endl;
  dq.push_back(5);dq.push_back(5);
  dq.push_back(67);dq.push_back(95);
  dq.push_back(76);dq.push_back(59);
  dq.emplace_back(3);dq.push_front(6);
  dq.emplace_front(1);
  for(auto it:dq){
         cout<<it<<" ";
     } 
 // why it didn't work dq.erase(3,5); 
  dq.pop_back();cout<<endl<<*dq.end()<<endl;
  dq.pop_front();cout<<*dq.begin()<<endl;
  cout<<dq.size()<<endl;
      for(auto it:dq){
         cout<<it<<" ";
     } 
